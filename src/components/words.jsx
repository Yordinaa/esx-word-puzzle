export default [
  ...
  { word: "Exchange‑Traded Fund (ETF)", hint: "A fund traded on an exchange, like a stock, tracking an index." },
  ...
  { word: "Earnings Per Share (EPS)", hint: "Company profit divided by number of outstanding shares." },
  { word: "Elasticity (of demand)", hint: "How market demand reacts to price changes in securities." },
  ...
  { word: "Foreign Direct Investment (FDI)", hint: "Investment into business operations in another country; influences capital flows." },
  ...
  { word: "Gross Domestic Product (GDP)", hint: "Total value of goods/services produced in a country; affects capital markets." },
  { word: "Green Bond", hint: "A bond issued to finance environmentally‑friendly or sustainable projects." },
  { word: "Global Depository Receipt (GDR)", hint: "A negotiable certificate representing shares of a foreign company, traded locally." },
  ...
  { word: "Good‑Till‑Cancelled (GTC) Order", hint: "A trading order type that remains active until executed or cancelled." },
  ...
  { word: "High‑Frequency Trading (HFT)", hint: "Algorithmic trading with very short holding periods, high turnover in securities markets." },
  ...
  { word: "Head and Shoulders (chart pattern)", hint: "A technical‑analysis formation in equity/trading markets signaling potential trend reversal." },
  ...
  {word: "Internal Rate of Return (IRR)", hint: "Expected annualized return of an investment"},
  ...
  {word: "Liquidity Coverage Ratio (LCR)", hint: "Measure of a bank’s ability to cover short-term obligations"},
  ...
  {word: "Net Asset Value (NAV)", hint: "Value of a fund’s assets minus liabilities, per share/unit" },
  ...
  {word: "Over-the-Counter (OTC)", hint: "Trading done directly, not through a formal exchange" },
